...
def exp_details(args):
    ...
    # NEW: Add quality metric parameters (dynamic version)
    print('\n    Quality Metric Parameters:')
    if hasattr(args, 'quality_alpha'):
        ...
        print(f'    Quality Metric Type: {args.quality_metric_type}')
    else:
        # Fallback to default StableQualityMetric values
        print(f'    Alpha (Loss Weight): 0.3')
        print(f'    Beta (Consistency Weight): 0.2') 
        print(f'    Gamma (Data Weight): 0.5')
        print(f'    Quality Metric Type: StableQualityMetric')
